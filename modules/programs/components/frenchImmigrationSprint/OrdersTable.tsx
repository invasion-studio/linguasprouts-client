...
import FilterGroup, {
  FilterButton,
} from "../../../../components/FilterGroup/FilterGroup";
import {
  DesktopTableSkeleton,
  MobileTableSkeleton,
  NoDataSkeleton,
} from "../../../../components/AdminTableSkeleton/AdminTableSkeleton";
import { useGetFrenchImmigRegs } from "../../hooks/frenchImmigrationSprint/useGetFrenchImmigRegs";
...
export default function FrenchImmigOrders({
  onVerify,
  isVerifying,
  isError,
  error,
  ...
  const handleConfirmVerify = async () => {
    if (selectedPayment) {
      await onVerify(selectedPayment.interacPaymentId);
      handleCloseDialog();
    }
  };
